...
public class AnimalService {
    ...
    static {
        ...
        ANIMALS.add(new Animal(CURRENT_INDEX++, "Turtle Leonardo", 36, "https://i1.wp.com/www.teenagemutantninjaturtles.com/wp-content/uploads/2012/04/Leonardo-2003-cartoon.jpg", "Leonardo, nickname Leo, is a fictional character and one of the four main characters in Teenage Mutant Ninja Turtles comics and all related media.[1][2]", AnimalType.REPTILE));
        ANIMALS.add(new Animal(CURRENT_INDEX++, "Nemo", 14, "https://vignette.wikia.nocookie.net/pixar/images/3/39/59.png", "Nemo fish",  AnimalType.FISH));
